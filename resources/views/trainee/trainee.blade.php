        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
					...
					<div class="well">
                        <h3>To Give FeedBack<br><a href="{!! URL::to('/trainee/feedbacks/feedbackCreate') !!}" class="btn btn-lg btn-info" style="background-color:#5C6BC0">Click Here</a></h3>
                    </div>
					<br>
                    <div class="well">
                        <h3>Health Details<a href="{!! URL::to('/trainee/health/create') !!}" class="btn btn-lg btn-info"  style="background-color:#FFE082" >Fill Up The Form</a></h3>
						<a href="{!! URL::to('/trainee/health/create') !!}" class="btn btn-lg btn-info" style="background-color:#FFA000">Edit The Form</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="well">
