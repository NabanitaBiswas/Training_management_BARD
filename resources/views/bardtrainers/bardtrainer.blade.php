							...
							<div class="row">
								<div class=" col-md-8 col-lg-8 "> 
									...
									<div class=" col-md-3 col-lg-3">
										<h4 style="color:#2196F3"><!--<a href="{!! action('BardTrainersController@show', $bardtrainer->slug) !!}">!-->{!! $bardtrainer->name !!} </a></h4>
										   From: {!! $bardtrainer->country !!}<br>
											  Email: {!! $bardtrainer->email !!}<br> Phone Number: 
											 {!! $bardtrainer->cell_number !!}
