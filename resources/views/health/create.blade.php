...
@section('content')
   ...
   <form id="contactForm" class="form-horizontal" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
           a. Navel:<input type="name" class="form-control" id="inputNavel" placeholder="" name="navel" value="{{old('navel')}}">
        </div><br>
        <div class="col-sm-6">
           d. Anemia:<input type="name" class="form-control" id="inputAnemia" placeholder="" name="anemia" value="{{old('anemia')}}">
        </div><br>
        <div class="col-sm-6">
           b. Blood Pressure:<input type="name" class="form-control" id="inputPressure" placeholder="" name="blood_pressure" value="{{old('blood_pressure')}}">
        </div><br>
        <div class="col-sm-6">
            e. Jaundice:<input type="name" class="form-control" id="inputJaundice" placeholder="" name="jaundice" value="{{old('jaundice')}}">
        </div><br>
        <div class="col-sm-6">
            c. Respiration:<input type="name" class="form-control" id="inputRespiration" placeholder="" name="respiration" value="{{old('respiration')}}">
        </div><br>
        <div class="col-sm-6">
           f. Weight:<input type="name" class="form-control" id="inputWeight" placeholder="" name="weight" value="{{old('weight')}}">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
          a. Heart:<input type="name" class="form-control" id="inputHeart" placeholder="" name="heart" value="{{old('heart')}}">
        </div><br>
        <div class="col-sm-6">
            e. Kidney:<input type="name" class="form-control" id="inputKidney" placeholder="" name="kidney" value="{{old('kidney')}}">
        </div><br>
        <div class="col-sm-6">
            b. Lung:<input type="name" class="form-control" id="inputLung" placeholder="" name="lung" value="{{old('lung')}}">
        </div><br>
        <div class="col-sm-6">
            f. Hernia:<input type="name" class="form-control" id="inputHernia" placeholder="" name="hernia" value="{{old('hernia')}}">
        </div><br>
        <div class="col-sm-6">
            c. Liver:<input type="name" class="form-control" id="inputLiver" placeholder="" name="liver" value="{{old('liver')}}">
        </div><br>
        <div class="col-sm-6">
            g. Hydrocil:<input type="name" class="form-control" id="inputHydrocil" placeholder="" name="hydrocil" value="{{old('hydrocil')}}">
        </div>
        <div class="col-sm-6">
            d. Spleen:<input type="name" class="form-control" id="inputSpleen" placeholder="" name="spleen" value="{{old('spleen')}}">
        </div>
