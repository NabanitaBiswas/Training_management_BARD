                       ...
                       <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-lg-4">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-6 control-label"><h4 align = "left"><b> A2. S/he spoke clearly and at a good pace &nbsp;<span class="red-star" style="color:red">★</span></b> </h4></label>
                                ...
                                <div class="form-group">
                                    <label class="col-lg-6 control-label"><h4 align = "left"><b> A3. S/he spoke loud enough. S/he used good eye contact,body language and non-verbal communication skills &nbsp;<span class="red-star" style="color:red">★</span></b> </h4></label>
                                        <div class="radio">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-6 control-label"> <h4 align = "left"><b>A4. Speaker's Rapport building with participants &nbsp;<span class="red-star" style="color:red">★</span></b> </h4></label>
                                        <div class="radio">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-6 control-label"><h4 align = "left"><b> A5. Speaker's Interaction with Participants &nbsp;<span class="red-star" style="color:red">★</span></b></h4></label>
                                        <div class="radio">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-6 control-label"><h4 align = "left"> <b> B1. Presentation topic was useful and of interest to me personally &nbsp;<span class="red-star" style="color:red">★</span></b> </h4></label>
                                        <div class="radio">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-6 control-label"><h4 align = "left"><b>B2. The presentation meterial was well-organized and easy to follow &nbsp;<span class="red-star" style="color:red">★</span> </b></h4></label>
                                        <div class="radio">
                                ...
                                <div class="form-group">
                                    <label class="col-lg-6 control-label"><h4 align = "left"><b> B3. The Speaker was prepared and Knowledgeable on the topic &nbsp;<span class="red-star" style="color:red">★</span></b></h4></label>
                                        <div class="radio">
