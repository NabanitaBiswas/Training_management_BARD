...
class AdminTrainersController extends Controller
{
    ...
    {   
        ...
        //return $trainers;
        return view('admin.AdminTrainer.index', compact('trainers', 'courses'));
    ...
    {
         $trainer = AdminTrainer::whereSlug($slug)->firstOrFail();
    ...
    public function update($slug, TrainerFormRequest $request)
{
 ...
 $input=$request->all();
        ...
        if(isset($input['image'])) {
            ...
            $imagePath = AdminTrainer::where('slug', '=', $slug)->pluck('filePath');
            //dd($imagePath);
        }
